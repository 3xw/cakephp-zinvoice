<?php
namespace Trois\Zinvoice\View\Form;
...
class ResourceContext implements ContextInterface
{
    ...
    public function __construct(Request $request, array $data)
    {
        ...
        $this->_schema = $this->_endpoint->schema();
        //debug($this->_endpoint);
    }
    /**
    ...
    {
      if($this->_schema->column($field))
      {
        return $this->_schema->column($field)['primaryKey'];
      }
      return false;
    }
    /**
    ...
    {
      // Change using endpoint Validation to find what's really requiered
      if($this->_schema->column($field))
      {
        return $this->_schema->column($field)['primaryKey'];
      }
